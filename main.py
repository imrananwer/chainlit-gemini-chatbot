...
async def start():
    ...
    # Initialize and store data in the user's session
...
async def main(message: cl.Message):
    ...
    # Retrieve the agent, config, and history from the session
    ...
    try:
        ...
        # Run the agent synchronously with the current history
        ...
        # Optional: Log the interaction to the console for debugging
